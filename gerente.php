...
<div class="contenedor">
    <div class="content">
        <div class="header">
            <h1><blockquote>USUARIO DE GERENTE</blockquote></h1>
                <nav class="navbar">
                    <ul>
        ...
        <div class="contenido">
            <form name="registradatos" method="POST" action="Pav.php" id="registradatos">
                <table id="tablareg">
                    ...
                    <tr>
                        <td colspan="2" style="text-align:center">
                            <button type="button" id="BotonElimina" class="float-left submit-button">Eliminar viajes</button>
                            <button type="button" id="BotonActualiza" class="float-left submit-button">Modificar viajes</button>
                        </td>
                    </tr>
                </table>
            </form>
...
document.getElementById('BotonElimina').onclick = function() {
    const mensaje = document.getElementById('mensaje');
    mensaje.style.display = 'block';
    mensaje.innerHTML = 'Se requiere permiso de administrador para eliminar viajes.';
};

document.getElementById('BotonActualiza').onclick = function() {
    location.href = "Modviaj2.php";
};
</script>
</body>
</html>
