...
<head>
    ...
    <script type="text/javascript">
        function requierePermiso() {
            alert("Requiere permiso del administrador para eliminar usuarios.");
...
<div class="contenedor">
    <div class="content">
        <div class="header">
            ...
            <nav class="navbar">
                <ul>
                    <li><a href="gerente.php" target="_self">Regresar</a></li>    
                </ul>
            </nav>
        </div>
        <div class="contenido">
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>
                                    <form method='post' action='" . $_SERVER['PHP_SELF'] . "' onsubmit='return requierePermiso()'>
                                        <input type='hidden' name='Id' value='" . $row["Id"] . "'>
